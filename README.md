...
- Используются алиасы импортов (`@/components`, `@/assets` и т.д.)

## Функциональность

- Фильтрация каталога с помощью готовых фильтров и поиску.
...
Frontend Developer  
GitHub repository: https://github.com/Dissperss/Coffee-Shop
